...
export function routeTitles(locale: Locale) {
  const map = {
    en: {
      ...
      services: "Services — consultation & property review",
      about: "About Nomore",
      contacts: "Contacts",
    ...
    bg: {
      ...
      services: "Услуги — консултация и разбор на имот",
      about: "За Nomore",
      contacts: "Контакти",
      guide: "Гид и FAQ",
    ...
    ru: {
      ...
      services: "Услуги — консультация и разбор объекта",
      about: "О Nomore",
      contacts: "Контакты",
      guide: "Гид и FAQ",
    ...
    ua: {
      ...
      services: "Послуги — консультація та розбір об’єкта",
      about: "Про Nomore",
      contacts: "Контакти",
      guide: "Гід і FAQ",
