...
- **TZ:** [`docs/TZ.md`](./docs/TZ.md) · [`docs/TZ_PRODUCT.md`](./docs/TZ_PRODUCT.md) · [`docs/TZ_DEPLOY.md`](./docs/TZ_DEPLOY.md)  
...
Next.js 16 · Tailwind 4 · Vercel · listings in `src/data/listings.ts`
