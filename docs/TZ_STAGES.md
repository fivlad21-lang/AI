...
## Етап 1 — Довіра і особа ← поточний
- Hero структура як є; м’який підзаголовок
- Блок «Хто веде підбір» після how-it-works
- Owner: фінальний Instagram URL у `src/lib/contacts.ts` → `INSTAGRAM_URL`

## Етап 2 — Послуги CONSULT / AUDIT
## Етап 3 — Відео-стрічка
## Етап 4 — Паспорт лота + тип показу
